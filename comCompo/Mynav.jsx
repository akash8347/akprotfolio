...
export default function Mynav() {
  ...
  return (
    <span className="
    bg-white
     text-right ml-3 rounded-xl">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center 
          rounded-sm bg-white px-3 py-2 text-sm font-medium
           text-white  focus:outline-none 
            ...
            <ChevronDownIcon
              ...
              aria-hidden="true"
            /> */}
           <FontAwesomeIcon  icon={faBars}  aria-hidden="true" className="  text-black w-3 fa-lg"/>
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
